...
### Reset function
- **File:** [`Reset function(2).js`](./Reset function(2).js)
...
### Reset function
- **File:** [`Reset function(3).js`](./Reset function(3).js)
...
### beta_gate
- **File:** [`beta_gate.js`](./beta_gate.js)
...
#### Upstream
- status_panel_signal (function) — this tab, file: [`status_panel_signal.js`](./status_panel_signal.js)
...
### create_floor_heat
- **File:** [`create_floor_heat.js`](./create_floor_heat.js)
...
#### Upstream
- unique_floor_heat (function) — this tab, file: [`unique_floor_heat.js`](./unique_floor_heat.js)
...
- **File:** [`decode_ac_load_status.js`](./decode_ac_load_status.js)
...
#### Downstream
- **Output 0:**
  - status_ac_load (function) — this tab, file: [`status_ac_load.js`](./status_ac_load.js)

---

### decode_air_conditioner_status
- **File:** [`decode_air_conditioner_status.js`](./decode_air_conditioner_status.js)
...
- **File:** [`decode_ats_ac_status.js`](./decode_ats_ac_status.js)
...
### decode_ats_status
- **File:** [`decode_ats_status.js`](./decode_ats_status.js)
...
- **File:** [`decode_autofill_status.js`](./decode_autofill_status.js)
...
#### Downstream
- **Output 0:**
  - status_autofill (function) — this tab, file: [`status_autofill.js`](./status_autofill.js)

---

### decode_charger_ac_status
- **File:** [`decode_charger_ac_status.js`](./decode_charger_ac_status.js)
...
- **File:** [`decode_charger_status.js`](./decode_charger_status.js)
...
- **File:** [`decode_circulation_pump_status.js`](./decode_circulation_pump_status.js)
...
#### Downstream
- **Output 0:**
  - status_waterheater (function) — this tab, file: [`status_waterheater.js`](./status_waterheater.js)

---

### decode_dc_dimmer_status_3
- **File:** [`decode_dc_dimmer_status_3.js`](./decode_dc_dimmer_status_3.js)
...
#### Downstream
- **Output 0:**
  - status_dc_dimmer_3 (function) — this tab, file: [`status_dc_dimmer_3.js`](./status_dc_dimmer_3.js)

---

### decode_dc_driver_status
- **File:** [`decode_dc_driver_status.js`](./decode_dc_driver_status.js)
...
#### Downstream
- **Output 0:**
  - status_dc_driver (function) — this tab, file: [`status_dc_driver.js`](./status_dc_driver.js)

---

### decode_dc_load_status
- **File:** [`decode_dc_load_status.js`](./decode_dc_load_status.js)
...
#### Downstream
- **Output 0:**
  - status_dc_load (function) — this tab, file: [`status_dc_load.js`](./status_dc_load.js)

---

### decode_dc_source_status
- **File:** [`decode_dc_source_status.js`](./decode_dc_source_status.js)
...
#### Downstream
- **Output 0:**
  - status_battery (function) — this tab, file: [`status_battery.js`](./status_battery.js)

---

### decode_floor_heat_status
- **File:** [`decode_floor_heat_status.js`](./decode_floor_heat_status.js)
...
#### Downstream
- **Output 0:**
  - status_floor_heat (function) — this tab, file: [`status_floor_heat.js`](./status_floor_heat.js)
  - unique_floor_heat (function) — this tab, file: [`unique_floor_heat.js`](./unique_floor_heat.js)

---

### decode_furnace_status
- **File:** [`decode_furnace_status.js`](./decode_furnace_status.js)
...
#### Downstream
- **Output 0:**
  - status_furnace (function) — this tab, file: [`status_furnace.js`](./status_furnace.js)

---

### decode_generator_ac_status
- **File:** [`decode_generator_ac_status.js`](./decode_generator_ac_status.js)
...
#### Downstream
- **Output 0:**
  - status_generator (function) — this tab, file: [`status_generator.js`](./status_generator.js)

---

### decode_generator_demand_status
- **File:** [`decode_generator_demand_status.js`](./decode_generator_demand_status.js)
...
- **File:** [`decode_generator_status.js`](./decode_generator_status.js)
...
- **File:** [`decode_inverter_ac_status.js`](./decode_inverter_ac_status.js)
...
- **File:** [`decode_inverter_dc_status.js`](./decode_inverter_dc_status.js)
...
- **File:** [`decode_inverter_status.js`](./decode_inverter_status.js)
...
### decode_lock_status
- **File:** [`decode_lock_status.js`](./decode_lock_status.js)
...
#### Downstream
- **Output 0:**
  - status_lock (function) — this tab, file: [`status_lock.js`](./status_lock.js)

---

### decode_panel_signal
- **File:** [`decode_panel_signal.js`](./decode_panel_signal.js)
...
### decode_tank_status
- **File:** [`decode_tank_status.js`](./decode_tank_status.js)
...
#### Downstream
- **Output 0:**
  - status_tank (function) — this tab, file: [`status_tank.js`](./status_tank.js)

---

### decode_thermostat_ambient_status
- **File:** [`decode_thermostat_ambient_status.js`](./decode_thermostat_ambient_status.js)
...
#### Downstream
- **Output 0:**
  - status_thermostat_ambient (function) — this tab, file: [`status_thermostat_ambient.js`](./status_thermostat_ambient.js)

---

### decode_thermostat_status_1
- **File:** [`decode_thermostat_status_1.js`](./decode_thermostat_status_1.js)
...
#### Downstream
- **Output 0:**
  - status_thermostat (function) — this tab, file: [`status_thermostat.js`](./status_thermostat.js)

---

### decode_thermostat_status_2
- **File:** [`decode_thermostat_status_2.js`](./decode_thermostat_status_2.js)
...
- **File:** [`decode_water_pump_status.js`](./decode_water_pump_status.js)
...
#### Downstream
- **Output 0:**
  - status_water_pump (function) — this tab, file: [`status_water_pump.js`](./status_water_pump.js)

---

### decode_waterheater_status
- **File:** [`decode_waterheater_status.js`](./decode_waterheater_status.js)
...
- **File:** [`decode_window_shade_control_status.js`](./decode_window_shade_control_status.js)
...
#### Downstream
- **Output 0:**
  - status_shade (function) — this tab, file: [`status_shade.js`](./status_shade.js)

---

### status_ac_load
- **File:** [`status_ac_load.js`](./status_ac_load.js)
...
#### Upstream
- decode_ac_load_status (function) — this tab, file: [`decode_ac_load_status.js`](./decode_ac_load_status.js)
...
### status_autofill
- **File:** [`status_autofill.js`](./status_autofill.js)
...
#### Upstream
- decode_autofill_status (function) — this tab, file: [`decode_autofill_status.js`](./decode_autofill_status.js)
...
### status_battery
- **File:** [`status_battery.js`](./status_battery.js)
...
#### Upstream
- decode_dc_source_status (function) — this tab, file: [`decode_dc_source_status.js`](./decode_dc_source_status.js)
...
### status_dc_dimmer_3
- **File:** [`status_dc_dimmer_3.js`](./status_dc_dimmer_3.js)
...
#### Upstream
- decode_dc_dimmer_status_3 (function) — this tab, file: [`decode_dc_dimmer_status_3.js`](./decode_dc_dimmer_status_3.js)
...
### status_dc_driver
- **File:** [`status_dc_driver.js`](./status_dc_driver.js)
...
#### Upstream
- decode_dc_driver_status (function) — this tab, file: [`decode_dc_driver_status.js`](./decode_dc_driver_status.js)
...
### status_dc_load
- **File:** [`status_dc_load.js`](./status_dc_load.js)
...
#### Upstream
- decode_dc_load_status (function) — this tab, file: [`decode_dc_load_status.js`](./decode_dc_load_status.js)
...
### status_floor_heat
- **File:** [`status_floor_heat.js`](./status_floor_heat.js)
...
#### Upstream
- decode_floor_heat_status (function) — this tab, file: [`decode_floor_heat_status.js`](./decode_floor_heat_status.js)
...
### status_furnace
- **File:** [`status_furnace.js`](./status_furnace.js)
...
#### Upstream
- decode_furnace_status (function) — this tab, file: [`decode_furnace_status.js`](./decode_furnace_status.js)
...
### status_generator
- **File:** [`status_generator.js`](./status_generator.js)
...
#### Upstream
- decode_generator_ac_status (function) — this tab, file: [`decode_generator_ac_status.js`](./decode_generator_ac_status.js)
- decode_generator_demand_status (function) — this tab, file: [`decode_generator_demand_status.js`](./decode_generator_demand_status.js)
- decode_generator_status (function) — this tab, file: [`decode_generator_status.js`](./decode_generator_status.js)
...
### status_lock
- **File:** [`status_lock.js`](./status_lock.js)
...
#### Upstream
- decode_lock_status (function) — this tab, file: [`decode_lock_status.js`](./decode_lock_status.js)
...
### status_panel_signal
- **File:** [`status_panel_signal.js`](./status_panel_signal.js)
...
#### Upstream
- decode_panel_signal (function) — this tab, file: [`decode_panel_signal.js`](./decode_panel_signal.js)

#### Downstream
- **Output 0:**
  - beta_gate (function) — this tab, file: [`beta_gate.js`](./beta_gate.js)

---

### status_shade
- **File:** [`status_shade.js`](./status_shade.js)
...
#### Upstream
- decode_window_shade_control_status (function) — this tab, file: [`decode_window_shade_control_status.js`](./decode_window_shade_control_status.js)
...
### status_tank
- **File:** [`status_tank.js`](./status_tank.js)
...
#### Upstream
- decode_tank_status (function) — this tab, file: [`decode_tank_status.js`](./decode_tank_status.js)
...
### status_thermostat
- **File:** [`status_thermostat.js`](./status_thermostat.js)
...
#### Upstream
- decode_thermostat_status_1 (function) — this tab, file: [`decode_thermostat_status_1.js`](./decode_thermostat_status_1.js)
...
- **File:** [`status_thermostat_ambient.js`](./status_thermostat_ambient.js)
...
#### Upstream
- decode_thermostat_ambient_status (function) — this tab, file: [`decode_thermostat_ambient_status.js`](./decode_thermostat_ambient_status.js)
...
### status_water_pump
- **File:** [`status_water_pump.js`](./status_water_pump.js)
...
#### Upstream
- decode_water_pump_status (function) — this tab, file: [`decode_water_pump_status.js`](./decode_water_pump_status.js)
...
### status_waterheater
- **File:** [`status_waterheater.js`](./status_waterheater.js)
...
#### Upstream
- decode_circulation_pump_status (function) — this tab, file: [`decode_circulation_pump_status.js`](./decode_circulation_pump_status.js)
- decode_waterheater_status (function) — this tab, file: [`decode_waterheater_status.js`](./decode_waterheater_status.js)
...
### unique_floor_heat
- **File:** [`unique_floor_heat.js`](./unique_floor_heat.js)
...
#### Downstream
- **Output 0:**
  - create_floor_heat (function) — this tab, file: [`create_floor_heat.js`](./create_floor_heat.js)

---

### unique_status
- **File:** [`unique_status.js`](./unique_status.js)
...
- **Waterheater zone** (`3f467bbd66a21eb9`) →
  - Waterheater zone in tab `AquaHot` ([wiring](../aquahot/_wiring.md))
