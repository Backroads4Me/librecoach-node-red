...
// --- Parse Command ---
// JSON schema: payload is normally an object. Fall back to msg.command
// (always set by decode_ha_command) for plain-string payloads, so a string
// "OFF" is never misread as a toggle-on.
