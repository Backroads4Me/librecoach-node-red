...
#### Upstream
- microair_unique (function) — this tab, file: [`microair_unique.js`](../tabs/micro-air/microair_unique.js)
...
- **File:** [`microair_create_sensor.js`](../tabs/micro-air/microair_create_sensor.js)
...
- **File:** [`microair_decode_config.js`](../tabs/micro-air/microair_decode_config.js)
...
- **File:** [`microair_decode_status.js`](../tabs/micro-air/microair_decode_status.js)
...
- **File:** [`microair_encode_command.js`](../tabs/micro-air/microair_encode_command.js)
...
#### Downstream
- **Output 0:**
  - microair_optimistic_update (function) — this tab, file: [`microair_optimistic_update.js`](../tabs/micro-air/microair_optimistic_update.js)

---

### microair_handle_toggle
- **File:** [`microair_handle_toggle.js`](../tabs/micro-air/microair_handle_toggle.js)
...
- **File:** [`microair_optimistic_update.js`](../tabs/micro-air/microair_optimistic_update.js)
...
#### Upstream
- microair_encode_command (function) — this tab, file: [`microair_encode_command.js`](../tabs/micro-air/microair_encode_command.js)
...
### microair_unique
- **File:** [`microair_unique.js`](../tabs/micro-air/microair_unique.js)
...
#### Upstream
- microair_decode_config (function) — this tab, file: [`microair_decode_config.js`](../tabs/micro-air/microair_decode_config.js)
- microair_decode_status (function) — this tab, file: [`microair_decode_status.js`](../tabs/micro-air/microair_decode_status.js)
...
- **Reset Microair filters** (`cdc4754f4c43430d`) →
  - Reset Microair filters in tab `Micro-Air` ([wiring](./micro-air.md))
