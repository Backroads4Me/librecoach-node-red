...
The RV-C specification is available at `/home/ted/src/librecoach/librecoach-rvc/`. Device definitions are in `devices/06_*.md`. Always reference the spec for standard DGN layouts, byte maps, and enumeration values.
...
Key paths:
- Standard DGN definitions: `/home/ted/src/librecoach/librecoach-rvc/devices/`
- Proprietary device notes: `/home/ted/src/librecoach/librecoach-rvc/notes/`
- AquaHot protocol notes: `/home/ted/src/librecoach/librecoach-rvc/notes/aquahot.md`
